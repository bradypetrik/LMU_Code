...
public class CalendarStuffTester {
  ...
  /**
   * method to test the "isDateValid()" method in the CalendarStuff class
   * @return void
   */
   static void test_isDateValid() {

      System.out.println ( "\nEIGHT TESTS FOR isDateValid():" );

      System.out.print( "   Test January 1, 2000    : " );
      try { System.out.println( CalendarStuff.isDateValid(  1,  1, 2000 ) ? "valid" : "invalid" ); }
      catch( Exception e ) { System.out.println( false ); }

      System.out.print( "   Test February 29, 2001  : " );
      try { System.out.println( CalendarStuff.isDateValid(  2, 29, 2001 ) ? "valid" : "invalid" ); }
      catch( Exception e ) { System.out.println( false ); }

      System.out.print( "   Test December 31, 2014  : " );
      try { System.out.println( CalendarStuff.isDateValid( 12, 31, 2014 ) ? "valid" : "invalid" ); }
      catch( Exception e ) { System.out.println( false ); }

      System.out.print( "   Test December 0, 2000   : " );
      try { System.out.println( CalendarStuff.isDateValid( 12,  0, 2000 ) ? "valid" : "invalid" ); }
      catch( Exception e ) { System.out.println( false ); }

      System.out.print( "   Test December 32, 2005  : " );
      try { System.out.println( CalendarStuff.isDateValid( 12, 32, 2005 ) ? "valid" : "invalid" ); }
      catch( Exception e ) { System.out.println( false ); }

      System.out.print( "   Test Zeroary 15, 2005   : " );
      try { System.out.println( CalendarStuff.isDateValid(  0, 15, 2005 ) ? "valid" : "invalid" ); }
      catch( Exception e ) { System.out.println( false ); }

      System.out.print( "   Test Thirtember 1, 2005 : " );
      try { System.out.println( CalendarStuff.isDateValid( 13,  1, 2005 ) ? "valid" : "invalid" ); }
      catch( Exception e ) { System.out.println( false ); }

      System.out.print( "   Test February 29, 2004  : " );
      try { System.out.println( CalendarStuff.isDateValid(  2, 29, 2004 ) ? "valid" : "invalid" ); }
      catch( Exception e ) { System.out.println( false ); }
